...
router.get('/verify/:token', UsuarioEndpoints.verificarToken)
router.post('/admin', checkBodyParameters(['usu_email', 'usu_senha', 'usu_nome']), UsuarioEndpoints.createUsuario)
...
router.post('/', checkBodyParameters(['usu_email', 'usu_senha', 'usu_nome']), UsuarioEndpoints.createUsuarioSubordinado)
