...
const Tarefa: React.FC<Props> = ({ tarefa:{ tar_id, tar_objetivo, tar_data_cadastro, tar_data_termino, tar_situacao, pro_id }, processoId}) => {

    return (
        <Li as={Link} to={`/processos/${processoId || pro_id }/tarefas/${tar_id}`} situacao={tar_situacao}>
