...
const Tarefa: React.FC<Props> = ({ tarefa:{ tar_id, tar_objetivo, tar_data_cadastro, tar_data_termino, tar_situacao }, processoId}) => {


    return (
        <Li as={Link} to={`/processos/${processoId}/tarefas/${tar_id}`} situacao={tar_situacao}>
